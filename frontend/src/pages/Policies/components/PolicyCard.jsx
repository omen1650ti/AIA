...
const PolicyCard = ({ policy, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="w-[90%] max-w-4xl bg-white border border-slate-100 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row items-center justify-between transition-all hover:shadow-xl hover:-translate-y-1 cursor-pointer group mb-4"
    >
