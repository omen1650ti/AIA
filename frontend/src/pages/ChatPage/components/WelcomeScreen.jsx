...
const WelcomeScreen = React.memo(({ onSend }) => { 
  return (
    <motion.div
      ...
      style={{ display: "flex", flexDirection: "column", gap: 18, paddingTop: 4 }}
    >
      {/* Greeting bubble */}
      <div style={{ display: "flex", alignItems: "flex-end", gap: 8 }}>
        ...
        >
          Hello! I'm your insurance assistant. Try saying{" "}
          <strong style={{ fontWeight: 700 }}>"Find health insurance for age 25"</strong>{" "}
          or{" "}
          <strong style={{ fontWeight: 700 }}>"Show me policies under $100"</strong>.
        </motion.div>
      </div>
