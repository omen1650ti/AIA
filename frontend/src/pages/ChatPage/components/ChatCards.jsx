  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          I've tailored the policy results based on your details. You can view
          the matching plans on your dashboard.
        </p>
      </div>
    </motion.div>
  );
      ...
      >
        ...
        {[data.insight, data.insight2].filter(Boolean).map((ins, i) => (
          ...
          >
            <CheckCircle2
              size={14}
              style={{ color: T.purple, flexShrink: 0, marginTop: 1 }}
            />
            <span
              style={{ fontSize: 12, color: T.textPrimary, lineHeight: 1.55 }}
            >
              {ins}
            </span>
          </motion.div>
        ...
        {data.comparison?.map((p, i) => (
          <motion.div
            ...
            style={{
              ...
              padding: "10px 0",
              borderBottom:
                i < data.comparison.length - 1 ? "1px solid #f3f4f6" : "none",
            }}
          >
            ...
            <span
              style={{
                ...
                background:
                  p.status === "yes" ? "rgba(22,163,74,0.08)" : "transparent",
                padding: "2px 8px",
                borderRadius: T.radius.full,
              }}
            >
